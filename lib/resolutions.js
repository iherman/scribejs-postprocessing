 ...
 * 
 * @param {String[]} file_names - List of the minute file names: this is either abase name for local usage or the last part of the URL when retrieving from Github
